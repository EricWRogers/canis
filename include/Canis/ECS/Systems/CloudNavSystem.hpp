...
namespace Canis
{
    class CloudNavSystem : public System
    {
    public:
        CloudNavSystem();
    ...
    private:
        ...
        bool IsPointClear(const CloudNavSurface& _surface, const Vector3& _point) const;
        bool HasClearance(
            const CloudNavSurface& _surface,
            const Vector3& _from,
            const Vector3& _to) const;
        bool IsBlockingHit(const CloudNavSurface& _surface, const Entity* _entity) const;
    };
}
