    ...
    namespace
    {
        ...
        void ApplyEditorThemeStyle(int _themeSelection, float _uiScale)
        {
            ...
            else
            {
                ...
                // Canis' editor palette mirrors the compact blue-gray visual
                // language used by the Odin rewrite. Keep every value here so
                // all native panels, popups, tables, and docking previews
                ...
                colors[ImGuiCol_WindowBg]             = ImVec4(0.105f, 0.118f, 0.145f, 1.00f);
                colors[ImGuiCol_ChildBg]              = ImVec4(0.118f, 0.132f, 0.160f, 1.00f);
                colors[ImGuiCol_PopupBg]              = ImVec4(0.095f, 0.106f, 0.130f, 0.98f);
                ...
                colors[ImGuiCol_TitleBgCollapsed]     = ImVec4(0.075f, 0.085f, 0.105f, 0.85f);
                colors[ImGuiCol_MenuBarBg]            = ImVec4(0.075f, 0.085f, 0.105f, 1.00f);
                ...
                colors[ImGuiCol_ResizeGrip]           = ImVec4(0.29f, 0.55f, 0.78f, 0.25f);
                colors[ImGuiCol_ResizeGripHovered]    = ImVec4(0.29f, 0.55f, 0.78f, 0.67f);
                colors[ImGuiCol_ResizeGripActive]     = ImVec4(0.29f, 0.55f, 0.78f, 0.95f);
                colors[ImGuiCol_Tab]                  = ImVec4(0.105f, 0.118f, 0.145f, 1.00f);
                colors[ImGuiCol_TabHovered]           = ImVec4(0.23f, 0.38f, 0.50f, 1.00f);
                colors[ImGuiCol_TabSelected]          = ImVec4(0.18f, 0.29f, 0.38f, 1.00f);
                colors[ImGuiCol_TabSelectedOverline]  = ImVec4(0.29f, 0.55f, 0.78f, 1.00f);
                colors[ImGuiCol_TabDimmed]            = ImVec4(0.085f, 0.095f, 0.118f, 1.00f);
                colors[ImGuiCol_TabDimmedSelected]    = ImVec4(0.14f, 0.20f, 0.26f, 1.00f);
                colors[ImGuiCol_DockingPreview]       = ImVec4(0.29f, 0.55f, 0.78f, 0.70f);
                colors[ImGuiCol_DockingEmptyBg]       = ImVec4(0.075f, 0.085f, 0.105f, 1.00f);
                colors[ImGuiCol_TableHeaderBg]        = ImVec4(0.14f, 0.16f, 0.20f, 1.00f);
                colors[ImGuiCol_TableBorderStrong]    = ImVec4(0.24f, 0.27f, 0.32f, 1.00f);
                colors[ImGuiCol_TableBorderLight]     = ImVec4(0.18f, 0.20f, 0.24f, 1.00f);
                colors[ImGuiCol_TableRowBg]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
                colors[ImGuiCol_TableRowBgAlt]        = ImVec4(0.14f, 0.16f, 0.20f, 0.35f);
                colors[ImGuiCol_TextSelectedBg]       = ImVec4(0.29f, 0.55f, 0.78f, 0.35f);
                colors[ImGuiCol_DragDropTarget]       = ImVec4(0.38f, 0.66f, 0.90f, 0.95f);
                colors[ImGuiCol_NavCursor]            = ImVec4(0.38f, 0.66f, 0.90f, 1.00f);
                colors[ImGuiCol_ModalWindowDimBg]     = ImVec4(0.03f, 0.04f, 0.06f, 0.70f);
            }
  ...
  DockNode        ID=0x00000002 Parent=0x49B9F6FE SizeRef=591,1142 Split=Y Selected=0x73E3D51F
    ...
    void Editor::DrawEditorPanel()
    {
        ...
        else
        {
            ...
            {
                ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.50f, 0.34f, 0.12f, 1.0f));
                ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(0.62f, 0.43f, 0.15f, 1.0f));
                ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(0.72f, 0.50f, 0.18f, 1.0f));
                const bool pausePressed = ImGui::Button("Pause##ScenePanel");
                ImGui::PopStyleColor(3);
                if (pausePressed || (ImGui::IsKeyDown(ImGuiKey_P) && ImGui::IsKeyDown(ImGuiKey_LeftCtrl) && hotKeyCoolDown < 0.0f))
                {
                    hotKeyCoolDown = HOTKEYRESET;
                    ReleasePlayMouseCapture();
            ...
            else if (m_mode == EditorMode::PAUSE)
            {
                ...
                ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(0.62f, 0.43f, 0.15f, 1.0f));
                ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(0.72f, 0.50f, 0.18f, 1.0f));
                const bool resumePressed = ImGui::Button("Resume##ScenePanel");
                ImGui::PopStyleColor(3);
                if (resumePressed || (ImGui::IsKeyDown(ImGuiKey_P) && ImGui::IsKeyDown(ImGuiKey_LeftCtrl) && hotKeyCoolDown < 0.0f))
                {
                    hotKeyCoolDown = HOTKEYRESET;
                    ReleasePlayMouseCapture();
                    m_mode = EditorMode::PLAY;
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.50f, 0.18f, 0.19f, 1.0f));
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(0.64f, 0.23f, 0.24f, 1.0f));
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(0.76f, 0.28f, 0.29f, 1.0f));
            const bool stopPressed = ImGui::Button("Stop##ScenePanel");
            ImGui::PopStyleColor(3);
            if (stopPressed || (ImGui::IsKeyDown(ImGuiKey_Q) && ImGui::IsKeyDown(ImGuiKey_LeftCtrl) && hotKeyCoolDown < 0.0f))
            {
                hotKeyCoolDown = HOTKEYRESET;
                StopPlayMode();
            }
